window.addEventListener("load", () => {
  ...
  const outerOutline = document.querySelector<SVGRectElement>(".outer-outline");
  const titleMain = document.querySelector<SVGGElement>(".title-main");
  const subtitleMain = document.querySelector<SVGGElement>(".subtitle-main");
  const block1 = document.querySelector<SVGGElement>(".block-1");
  const block2 = document.querySelector<SVGGElement>(".block-2");
  const block3 = document.querySelector<SVGGElement>(".block-3");
  const timelineDot = document.querySelector<SVGGElement>(".timeline-dot");
  const orbitRing = document.querySelector<SVGCircleElement>(".orbit-ring");
  const orbitDot = document.querySelector<SVGCircleElement>(".orbit-dot");
  const playGlow = document.querySelector<SVGGElement>(".play-glow");
  ...
  const titleText = document.querySelector<SVGTextElement>("#title-typewriter");
