...
function initHomePage() {
    ...
    if (scrollBox && typeof window.ScrollTrigger !== "undefined") {
        ...
        gsap.fromTo(scrollBox, {
            ...
            background: "radial-gradient(circle at 0 0, rgba(56,189,248,0.18), transparent 55%), rgba(15,23,42,0.9)",
            scrollTrigger: {
...
function initSvgPresentationPage() {
    // Pour l’instant, l’animation SVG de cette page est purement en CSS.
    // Cette fonction est prête si tu veux ajouter du JS/GSAP spécifique plus tard.
}
window.addEventListener("load", () => {
    ...
    else if (page === "svg-presentation") {
        initSvgPresentationPage();
    }
});
